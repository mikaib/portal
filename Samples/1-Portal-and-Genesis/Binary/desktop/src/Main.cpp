...
HXLINE(  94)		this->ptBackend = ::portal::_Portal_obj::createBackend(::portal::_Portal_obj::getOptimalBackendType());
HXLINE(  96)		this->ptConfig = ::portal::_Portal_obj::createConfig();
HXLINE(  97)		(*(this->ptConfig)).backend = this->ptBackend;
HXLINE(  99)		::portal::_Portal_obj::init(this->ptConfig);
HXLINE( 101)		this->window = ::portal::_Portal_obj::createWindow(HX_("Genesis [1 - Hello Triangle]",82,bf,f6,eb),600,600);
HXLINE( 102)		::portal::_Portal_obj::useGLContext(this->window);
            	}
...
HXLINE( 106)		::portal::_Portal_obj::destroyWindow(this->window);
HXLINE( 107)		::portal::_Portal_obj::shutdown();
            	}
...
HXLINE( 112)		this->backend = ::genesis::_Genesis_obj::createBackend(::genesis::_Genesis_obj::getOptimalBackendType());
HXLINE( 115)		this->config = ::genesis::_Genesis_obj::createConfig();
HXLINE( 116)		(*(this->config)).backend = this->backend;
HXLINE( 119)		::genesis::_Genesis_obj::init(this->config);
HXLINE( 122)		this->commandList = ::genesis::_Genesis_obj::createCommandList();
HXLINE( 125)		this->vertexShader = ::genesis::_Genesis_obj::createShader(GS_SHADER_TYPE_VERTEX,this->vertexShaderSource.utf8_str());
HXLINE( 126)		this->fragmentShader = ::genesis::_Genesis_obj::createShader(GS_SHADER_TYPE_FRAGMENT,this->fragmentShaderSource.utf8_str());
HXLINE( 129)		this->program = ::genesis::_Genesis_obj::createProgram();
HXLINE( 130)		::genesis::_Genesis_obj::programAttachShader(this->program,this->vertexShader);
HXLINE( 131)		::genesis::_Genesis_obj::programAttachShader(this->program,this->fragmentShader);
HXLINE( 132)		::genesis::_Genesis_obj::programBuild(this->program);
HXLINE( 135)		this->layout = ::genesis::_Genesis_obj::createLayout();
HXLINE( 136)		{
HXLINE( 136)			 GsVtxLayout * _this = this->layout;
HXDLIN( 136)			::genesis::_Genesis_obj::layoutAdd(_this,0,GS_ATTRIB_TYPE_FLOAT,3);
            		}
HXLINE( 137)		{
HXLINE( 137)			 GsVtxLayout * _this1 = this->layout;
HXDLIN( 137)			::genesis::_Genesis_obj::layoutAdd(_this1,1,GS_ATTRIB_TYPE_FLOAT,4);
            		}
HXLINE( 138)		::genesis::_Genesis_obj::layoutBuild(this->layout);
HXLINE( 141)		this->pipeline = ::genesis::_Genesis_obj::createPipeline();
...
HXLINE( 147)		this->vertexBuffer = ::genesis::_Genesis_obj::createBuffer(GS_BUFFER_TYPE_VERTEX,GS_BUFFER_INTENT_DRAW_STATIC);
HXLINE( 148)		{
...
HXDLIN( 148)			::genesis::_Genesis_obj::bufferSetData(_this2,::genesis::_GsManagedData::GsManagedData_Impl__obj::_new(ptr->ptr,(data->length * 4)));
            		}
HXLINE( 151)		this->indexBuffer = ::genesis::_Genesis_obj::createBuffer(GS_BUFFER_TYPE_INDEX,GS_BUFFER_INTENT_DRAW_STATIC);
HXLINE( 152)		{
HXLINE( 152)			 GsBuffer * _this3 = this->indexBuffer;
HXDLIN( 152)			::Array< int > data1 = this->indexData;
HXDLIN( 152)			::cpp::Pointer< void > ptr1 = ( (::cpp::Pointer< int >)(::cpp::Pointer_obj::arrayElem(data1,0)) )->reinterpret();
HXDLIN( 152)			::genesis::_Genesis_obj::bufferSetData(_this3,::genesis::_GsManagedData::GsManagedData_Impl__obj::_new(ptr1->ptr,(data1->length * 4)));
            		}
            	}
...
HXLINE( 157)		::genesis::_Genesis_obj::destroyCommandList(this->commandList);
HXLINE( 158)		::genesis::_Genesis_obj::destroyPipeline(this->pipeline);
HXLINE( 159)		::genesis::_Genesis_obj::destroyLayout(this->layout);
HXLINE( 160)		::genesis::_Genesis_obj::destroyBuffer(this->vertexBuffer);
HXLINE( 161)		::genesis::_Genesis_obj::destroyBuffer(this->indexBuffer);
HXLINE( 162)		::genesis::_Genesis_obj::destroyShader(this->vertexShader);
HXLINE( 163)		::genesis::_Genesis_obj::destroyShader(this->fragmentShader);
HXLINE( 164)		::genesis::_Genesis_obj::destroyProgram(this->program);
HXLINE( 167)		::genesis::_Genesis_obj::shutdown();
HXLINE( 170)		::genesis::_Genesis_obj::destroyBackend(this->backend);
HXLINE( 171)		::genesis::_Genesis_obj::destroyConfig(this->config);
            	}
...
HXDLIN( 175)			::genesis::_Genesis_obj::commandListBegin(_this);
            		}
HXLINE( 176)		{
HXLINE( 176)			 GsCommandList * _this1 = this->commandList;
HXDLIN( 176)			int width = ::portal::_Portal_obj::getFramebufferWidth(this->window);
HXDLIN( 176)			::genesis::_Genesis_obj::setViewport(_this1,0,0,width,::portal::_Portal_obj::getFramebufferHeight(this->window));
            		}
HXLINE( 177)		{
HXLINE( 177)			 GsCommandList * _this2 = this->commandList;
HXDLIN( 177)			::genesis::_Genesis_obj::clear(_this2,(1 | 2),( (Float)(0) ),( (Float)(0) ),( (Float)(0) ),( (Float)(1) ));
            		}
HXLINE( 178)		{
HXLINE( 178)			 GsCommandList * _this3 = this->commandList;
HXDLIN( 178)			::genesis::_Genesis_obj::usePipeline(_this3,this->pipeline);
            		}
HXLINE( 179)		{
HXLINE( 179)			 GsCommandList * _this4 = this->commandList;
HXDLIN( 179)			::genesis::_Genesis_obj::useBuffer(_this4,this->vertexBuffer);
            		}
HXLINE( 180)		{
HXLINE( 180)			 GsCommandList * _this5 = this->commandList;
HXDLIN( 180)			::genesis::_Genesis_obj::useBuffer(_this5,this->indexBuffer);
            		}
HXLINE( 181)		{
HXLINE( 181)			 GsCommandList * _this6 = this->commandList;
HXDLIN( 181)			::genesis::_Genesis_obj::drawIndexed(_this6,3);
            		}
HXLINE( 182)		{
HXLINE( 182)			 GsCommandList * _this7 = this->commandList;
HXDLIN( 182)			::genesis::_Genesis_obj::commandListEnd(_this7);
            		}
HXLINE( 183)		{
HXLINE( 183)			 GsCommandList * _this8 = this->commandList;
HXDLIN( 183)			::genesis::_Genesis_obj::commandListSubmit(_this8);
            		}
            	}
...
HXLINE( 187)		if ((::portal::_Portal_obj::shouldWindowClose(this->window) == 1)) {
HXLINE( 188)			this->destroy();
HXLINE( 189)			return;
            		}
HXLINE( 192)		this->frame();
HXLINE( 194)		::genesis::_Genesis_obj::frame();
HXLINE( 195)		::portal::_Portal_obj::swapBuffers(this->window);
HXLINE( 196)		::portal::_Portal_obj::pollEvents(this->window);
            	}
...
HXLINE( 203)		::genesis::_Genesis_obj::startMainloop(this->loop_dyn());
            	}
...
HXLINE( 207)		::genesis::_Genesis_obj::stopMainloop();
